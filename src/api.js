...
export const popularGamesURL = `${baseURL}/games/lists/popular?page_size=12`;
export const upcomingGamesURL = `${baseURL}/games/lists/recent-games-future?ordering=-added&page_size=12`;
export const newGamesURL = `${baseURL}/games/lists/recent-games?discover=true&ordering=-added&page_size=12`;
export const getGameDetailsURL = (id) => `${baseURL}/games/${id}`;
